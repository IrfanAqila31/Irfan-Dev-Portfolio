    ...
    <>
      <footer className="pt-26 pb-12 border-t border-slate-800">
        <div className="container mx-auto">
              ...
              <ul className="text-slate-400 space-y-2 text-sm">
                <li>
                  <a
                    ...
                    className="hover:text-indigo-400 transition-colors duration-200 flex items-center gap-2"
                  >
                    <svg
          ...
          {/* Copyright */}
          <div className="w-full mt-10 pt-6 border-t border-slate-800 text-center px-5">
