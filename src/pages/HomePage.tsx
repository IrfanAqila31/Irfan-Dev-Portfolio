      ...
      >
        <div className="px-5">
          ...
          >
            ...
            {/* Unduh CV */}
            <a
              href="/CV%20IRFAN%20AQILA%20UTAMA.pdf"
              download="CV IRFAN AQILA UTAMA.pdf"
              className="w-full sm:w-auto px-6 py-3 rounded-full text-slate-300 border border-slate-600 hover:border-indigo-400 hover:text-indigo-300 hover:bg-slate-800/60 transition font-medium duration-300 lg:text-md shadow-sm flex items-center justify-center gap-2"
            >
